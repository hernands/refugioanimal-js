...
const inputMail = document.querySelector("#mailUsuario");
const inputTelefono = document.querySelector("#telefonoUsuario");
const botonRegistro = document.getElementById("botonRegistro");

function prevenirRecarga(e) { e.preventDefault(); }

formularioRegistro.addEventListener('submit', prevenirRecarga());


let usuario = formularioRegistro.children[1].value;
